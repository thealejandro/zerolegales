                            ...
                            <form action="{{ route('login') }}" method="post">
                              @csrf
                                <div class="form-group">
                                    ...
                                    <input name="email" id="email" class="form-control form-control-rounded @error('email') is-invalid @enderror" type="email" value="{{ old('email') }}"  autocomplete="email" autofocus>
                                    @error('email')
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="password" name="password" class="form-control form-control-rounded @error('password') is-invalid @enderror" type="password" autocomplete="current-password">
                                    @error('password')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
