...
@section('content')
    <div class="breadcrumb">
        <h1>{{ __('test.Report4') }}</h1>
        <!-- <ul>
            <li>{{ __('test.Report') }}</li>
            <li>{{ __('test.Report4') }}</li>          
        ...
        <div class="col-md-12 mb-4">
            <div class="card text-left">
                ...
                <div class="table-responsive">
                    <table id="report4_table" class="display table table-striped table-bordered" style="width:100%">
                        <thead>
                            <tr>
                                <th>Escribe</th>
                                <th>Nombre del documento</th>
                                <th>Fecha de envío de la legalización</th>
                                <th>Fecha en que se completó la legalización</th>
                                <th>suscripción</th>
                                <th>Cantidad</th>
                            </tr>
                        </thead>
    ...
    <script>
        $(function() {
            ...
            table = $('#report4_table').DataTable({
                ...
                "scrollX": true,
                "ajax": {
                    url: "{{ route('admin.reports.report4.datatable') }}",
