                            ...
                            <div class="multi-head ">
                                <div class="d-flex justify-content-around">
                                    ...
                                    <div class="radio">
                                        ...
                                        <div class="custom-control cst-radio custom-radio mb-0 custom-control-inline">
                                            <input type="radio" id="anual" name="price" value="Annual" class="custom-control-input pricepln checked" checked>
                                    ...
                                    <div class="radio">
                                        ...
                                        <div class="custom-control cst-radio custom-radio mb-0 custom-control-inline">
                                            <input type="radio" id="anual" name="priceplan" value="Annual" class="custom-control-input pricepln checked" checked>
                                            <label class="custom-control-label ml-1" for="anual">Anual</label>
                                        </div>
                                    </div>
                                    @endif
