                                ...
                                <div class="d-flex justify-content-around">
                                    ...
                                    <div class="radio">
                                        <div class="custom-control cst-radio custom-radio mb-0 custom-control-inline">
                                            <input type="radio" id="mensual" name="price" value="Monthly" class="custom-control-input pricepln checked" checked>
                                            <label class="custom-control-label ml-1" for="mensual">Mensual </label>
                                        </div>
                                        <div class="custom-control cst-radio custom-radio mb-0 custom-control-inline">
                                            <input type="radio" id="anual" name="price" value="Annual" class="custom-control-input pricepln " >
                                    ...
                                    <div class="radio">
                                        <div class="custom-control cst-radio custom-radio mb-0 custom-control-inline">
                                            <input type="radio" id="mensual" name="priceplan" value="Monthly" class="custom-control-input pricepln checked" checked>
                                            <label class="custom-control-label ml-1" for="mensual">Mensual </label>
                                        </div>
                                        <div class="custom-control cst-radio custom-radio mb-0 custom-control-inline">
                                            <input type="radio" id="anual" name="priceplan" value="Annual" class="custom-control-input pricepln ">
                                            <label class="custom-control-label ml-1" for="anual">Anual</label>
                                        </div>
                                    </div>
                                    @endif
