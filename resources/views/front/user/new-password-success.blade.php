...
<meta charset="utf-8">
    ...
    <title>{{ config('app.name') }}  | {{__('test.Password Change Success Message')}}</title>
</head>
                    ...
                    <div class="col-lg-5 col-sm-12">
                        <div class="register-form-wrap">
                            ...
                            <div class="forgot-inst">
                                <h6 class="HeadlineH3-2 ">¡Contraseña Confirmada!</h6>
                                <p class="HeadlineH4-2">La nueva contraseña ha sido confirmada. Ahora puede inciar sesión nuevamente.</p>
                            </div>
                                ...
                                <div class="form-reg">
                                    <form>
                                        ...
                                        <div class="form-group log-mt-60">
                                            <a href="{{route('login')}}" class="btn btn-comon btn-blue d-full">Iniciar Sesión</a>
                                        </div>
