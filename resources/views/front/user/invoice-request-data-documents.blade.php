                                ...
                                <div class="col-md-7">
                                    <div class="SignContentModal">
                                        ...
                                        <div class="reg-bt-choose">
                                            @if($redirect == "BuyFillDocument")
                                                <a href="#" class="btn btn-comon btn-blue btn-block BuyFillDocument d-none">Ir a lista de documentos</a>
                                                <!-- <a href="{{route('user.cybersource.payment.response.updateBuyFillDocument',['req_transaction_uuid'=>$data['req_transaction_uuid'], 'transaction_id'=>$data['req_transaction_uuid']])}}" class="btn btn-comon btn-blue">Continuar</a> -->
                                                <a href="#" class="btn btn-comon btn-blue btn-block BuyFillDocument">Continuar</a>
                                                @elseif($redirect == "FillBuyDocument")
                                                <a href="#" class="btn btn-comon btn-blue btn-block FillBuyDocument d-none">Ir a lista de documentos</a>
                                                <!-- <a href="{{route('user.cybersource.payment.response.updateFillBuyDocument',['req_transaction_uuid'=>$data['req_transaction_uuid'], 'transaction_id'=>$data['req_transaction_uuid']])}}" class="btn btn-comon btn-blue">Continuar</a> -->
                                                <a href="#" class="btn btn-comon btn-blue btn-block FillBuyDocument">Continuar</a>
                                                @elseif($redirect == "FillBuyPurchase")
                                            <a href="#" class="btn btn-comon btn-blue btn-block FillBuyPurchase d-none">Ir a lista de documentos</a>
                                            <!-- <a href="{{route('user.cybersource.payment.response.updateFillBuyPurchase',['req_transaction_uuid'=>$data['req_transaction_uuid'], 'transaction_id'=>$data['req_transaction_uuid']])}}" class="btn btn-comon btn-blue">Continuar</a> -->
                                            <a href="#" class="btn btn-comon btn-blue btn-block FillBuyPurchase">Continuar</a>
                                            @elseif($redirect == "LegalisationPurchase")
                                            <a href="#" class="btn btn-comon btn-blue btn-block LegalisationPurchase d-none">Ir a lista de documentos</a>
                                            <!-- <a href="{{route('user.cybersource.payment.response.updateLegalisationPurchase',['req_transaction_uuid'=>$data['req_transaction_uuid'], 'transaction_id'=>$data['req_transaction_uuid']])}}" class="btn btn-comon btn-blue">Continuar</a> -->
                                            <a href="#" class="btn btn-comon btn-blue btn-block LegalisationPurchase">Continuar</a>
                                            @elseif($redirect == "Checklist")
                                            <a href="#" class="btn btn-comon btn-blue btn-block Checklist d-none">Ir a lista de documentos</a>
                                            <!-- <a href="{{route('user.cybersource.payment.response.updateChecklist',['req_transaction_uuid'=>$data['req_transaction_uuid'], 'transaction_id'=>$data['req_transaction_uuid']])}}" class="btn btn-comon btn-blue">Continuar</a> -->
                                            <a href="#" class="btn btn-comon btn-blue btn-block Checklist">Continuar</a>
                                            @else
                                            <a href="#" class="btn btn-comon btn-blue">Continuar</a>
                                            @endif
...
@endsection
@push('js')
<script src="{{ asset('front/assets/custom/js/data_invoice_document.js')}}"></script>
