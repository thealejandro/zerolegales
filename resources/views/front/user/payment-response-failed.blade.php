            ...
            <nav class="main-nav">
                    ...
                    @if (Auth::check())
                        <ul class="mr-auto">
                            ...
                            <?php /*
                            <li  {{ request()->route()->getName() === 'user.document' ? 'class=active' : '' 
...
<head>
    ...
    <title>HerramientasLegales | Payment Fail</title>
</head>
<style>
.payment-fail-wrap .reg-bt-choose {
    margin-top: 1.75rem;
}
 .HeadlineH2-2 {
...
@media (max-width:767px){
    ...
    .payment-fail-wrap  .reg-bt-choose.payment-success-bt .btn-comon:first-child {
        margin-right: auto!important;
        margin-left:auto;
    }
    .payment-fail-wrap  .reg-bt-choose.payment-success-bt .btn-comon{
        margin-right: auto;
        margin-left:auto;
        display: block;
    }
...
.payment-fail-wrap .subscribe-content{
    max-width: 27.5rem;
...
<body>
    <main class="subscription-page subscribe-page payment-fail-wrap">
...
Puede intentar ingresar nuevamente para solucionar el error. </h4>
                                                    <div class="reg-bt-choose payment-success-bt">
                                                        <a href="{{route('user.document')}}" class="btn btn-comon btn-blue btn-block">Intentar de Nuevo</a>
                                                     </div>
                                                </div>
                                            </div>
