                                                ...
                                                <tr>
                                                   ...
                                                   margin: 0 auto;">
                                                                <a href="#" style="cursor:default!important;">
                                                                    <img src="https://herramien.webc.in/front/assets/img/purchase.png" style="width: 100%;height:100%;cursor:default!important;    max-width: 300px;
                                                      margin: 0 auto;
                                                      ...
                                                      letter-spacing: normal;
                                                      color: #323232;">
                                                                    Acaba de adquirir la suscripción <span style="    color: #294f74!important;
                                                         font-weight: 500;">{{$data['subscription']}}</span> a un precio de <span style="    color: #294f74!important;
                                                         font-weight: 500;">Q {{$data['price']}}.</span> Ya puede iniciar a gozar de los distintos beneficios que esta suscripción le ofrece.
                                                                </p>
                                                      ...
                                                      color: #323232;">
                                                                ...
                                                                <div class="user-info" style="    margin-top: 22px;">
                                                                    <table class="legal-info-wrap" style="width: 100%;">
                                                                        <tbody>
                                                                            <tr class=" ">
                                                                                <td class="  col-md-51" style="vertical-align: top;">
                                                                     ...
                                                                     font-family: Roboto;
                                                                     color: #323232;
                                                                     word-wrap: break-word;">{{$data['subscription']}}
                                                                                        </li>
                                                                     ...
                                                                     font-family: Roboto;
                                                                     color: #323232;
                                                                     word-wrap: break-word;">{{$data['current_date']}}
                                                                                        </li>
                                                                     ...
                                                                     font-family: Roboto;
                                                                     color: #323232;
                                                                     word-wrap: break-word;">Q {{$data['price']}}
                                                                                        </li>
                                                      ...
                                                      <a style="    background: #294f74;
                                                         ...
                                                         line-height: 0;
                                                         margin-right: 20px;
                                                         transition: 0.3s ease-in-out;" href="{{route('user.purchase.history')}}" class="ma-verify"><span style="text-align: center; display: inline-block;   
                                                         font-size: 12px;
                                                         font-weight: bold;
