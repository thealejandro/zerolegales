                                             ...
                                             <div class="text ma-des"
                                                ...
                                                <div class="center-text" style="    margin-top: 25px;">
                                                   ...
                                                   <p style="padding-bottom: 15px;
                                                      ...
                                                      letter-spacing: normal;
                                                      color: #323232;">
                                                     El cambio de su suscripción <span style="color: #294f74!important;font-weight: 500;">{{$data['last_subscription']}}</span>
                                                     a la suscripción <span style="color: #294f74!important;font-weight: 500;">{{$data['new_subscription']}}</span> ha sido exitosa. Al finalizar el periodo restante de su subscripción, podra gozar de los distintos beneficios que su nueva suscripción le ofrece.
