                                                ...
                                                <div class="center-text" style="    margin-top: 25px;">
                                                   ...
                                                   <p style="    padding-right: 0em;
                                                      ...
                                                      ¡Hola <span class="fn-bold" style="    color: #294f74!important;
                                                         font-weight: bold;">{{$data['user_name']}}</span>!
                                                   </p>
                                                   <p style="padding-bottom: 15px;
                                                      ...
                                                      letter-spacing: normal;
                                                      color: #323232;">
                                                     La cancelación de su suscripción <span style="color: #294f74!important;font-weight: bold;">{{$data['subscription_name']}}</span>
                                                     a sido exitosa. La renovación ya no se hará automáticamente y dejará de tener las funcionalidades de su suscripción una vez que finalice el tiempo restante. 
                                                   </p>
                                                   <div style="text-align: center;margin-top:45px">
                                                      <a style="    background: #294f74;
                                                         ...
                                                         line-height: 5px;
                                                         margin-right: 20px;
                                                         transition: 0.3s ease-in-out;" href="{{route('user.price')}}" class="ma-verify"><span style="text-align: center; display: inline-block;   
                                                         font-size: 12px;
                                                         font-weight: bold;
                                                         color: #fff!important;">Ver Precios</span></a>
                                                   </div>
                                                </div>
                                             </div>
                                          </td>
