                                 ...
                                 <td class="logo" style="text-align: left;">
                                    <div style=" margin-bottom: 0;padding-bottom: 0;">
                                       <div class="logo_wrap" style="width: 55%;
                                          ...
                                          <a href="#">
                                          <img style="width: 100%;"
                                             src="https://herramien.webc.in/front/assets/img/logo_mail.png">
                                          </a>
                                       </div>
                                    </div>
                                 </td>
                                          ...
                                          <td>
                                             <div class="text ma-des"
                                                ...
                                                <div class="illu-img" style="    width: 294px;
                                                   ...
                                                   <img src="https://herramien.webc.in/front/assets/img/verify.png"
                                                ...
                                                <div class="center-text" style="    margin-top: 25px;">
                                                   ...
                                                   <p style="padding-bottom: 15px;
                                                      ...
                                                      letter-spacing: normal;
                                                      color: #323232;">
                                                      Bienvenido a Herramientas Legales. Todo está listo
                                                      para que disfrute de nuestros servicios, solo tiene
                                                      que verificar su correo dandolé click al botón de
                                                      abajo.
                                                   </p>
                                                   <div style="text-align: center;margin-top:45px">
                                                      <a style="    background: #294f74;
                                                         ...
                                                         line-height: 5px;
                                                         margin-right: 20px;
                                                         transition: 0.3s ease-in-out;" href="{{route('mail.verification', $data['token'])}}" class="ma-verify"><span style="text-align: center; display: inline-block;   
                                                         font-size: 12px;
                                                         font-weight: bold;
                                                         color: #fff!important;">Verificar</span></a>
                                                   </div>
                                                </div>
                                             </div>
                                          </td>
