                                          ...
                                          <td>
                                             <div class="text ma-des"
                                                ...
                                                <div class="illu-img" style="    width: 294px;
                                                   ...
                                                   <img src="{{ $message->embed('public/storage/'.$data['document_image'])}}"
                                                ...
                                                <div class="center-text" style="    margin-top: 25px;">
                                                   ...
                                                   <p style="padding-bottom: 15px;
                                                      ...
                                                      letter-spacing: normal;
                                                      color: #323232;">
                                                     Su documento <span style="color: #294f74!important;font-weight: 500;">{{$data['document_name']}},</span>
                                                     creado el <span style="color: #294f74!important;font-weight: 500;">{{$data['created_at']}},</span>está a punto de expirar.Si necesita renovar el documento, por favor adquieralo de nuevo
                                                    <div style="text-align: center;margin-top:45px">
                                                      <a style="    background: #294f74;
                                                         ...
                                                         line-height: 0;
                                                         margin-right: 20px;
                                                         transition: 0.3s ease-in-out;" href="{{route('user.myfolder.index')}}" class="ma-verify"><span style="text-align: center; display: inline-block;   
                                                         font-size: 12px;
                                                         font-weight: bold;
                                                         color: #fff!important;">Ver Mis Documentos</span></a>
                                                   </div>
                                                </div>
                                             </div>
                                          </td>
