...
<head>
    ...
    <title>HerramientasLegales | Email New Password</title>
...
<body>
    ...
    box-shadow: 0 2px 10px 2px rgba(194, 194, 194, 0.21), 10px 20px 20px 1px rgba(200, 200, 200, 0.28);">
                        ...
                        <tr>
                            <td valign="top" class="bg_white hl_header" background="http://comdudes.com/demo/hl-html/hl/assets/img/shape_blue-01.png" style="padding: 29px 33px 8px;
    border-top-left-radius: 10px;
    border-top-right-radius: 10px;
    position: relative;
    background-color: #fff;
    ...
    position: relative;">
                                                    <a href="#">
                                                        ...
                                                        <img style="width: 100%;" src="http://comdudes.com/demo/hl-html/hl/assets/img/logo-horizontal.png">
                                                    </a>
                                                </div>
    ...
    margin: 0 auto;">
                                                            <a href="#" style="cursor:default!important;">
                                                                <img src="http://comdudes.com/demo/hl-html/hl/assets/img/success.png" style="width: 100%;height:100%;cursor:default!important; max-width: 240px;
    margin: 0 auto;
...
">Cambiar Contraseña</h3>
    ...
    font-weight: 500;">{{$data['name']}}</span>!</p>
    ...
    color: #323232;">
                                                                    ...
                                                                    ¿Olvidó su contraseña? No hay problema. Dele click al botón para cambiar su contraseña. Si usted no solicitó el cambio de contraseña, ignore este mensaje.
                                                                </p>
                                                                <div class="" style="text-align: center;margin-top:45px">
                                                                    <a href="{{asset('new-password')}}/{{$data['user_id']}}" class="passwsucc" style="background: #294f74;
            color: #fff !important;
            text-decoration: none;
            border-radius: 10px;
            min-width: 190px;
    ...
    padding-bottom: 11px;
            line-height: 0;
            transition: 0.3s ease-in-out;"><span class="mvarify-text-2" style=" font-size: 12px;
                                                         font-weight: bold;
                                                         color: #fff!important;">Cambiar Contraseña</span></a>
