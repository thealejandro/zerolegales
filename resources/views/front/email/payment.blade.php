...
Su compra ha sido exitosa. Estos son los datos de su compra:
                                                                </p>
                                                                ...
                                                                <div class="user-info" style="    margin-top: 22px;">
                                                                    <table class="legal-info-wrap" style="width: 100%;">
                                                                     ...
                                                                     font-family: Roboto;
                                                                     color: #323232;
                                                                     word-wrap: break-word;">Compra de Documento (Tipo)
                                                                                        </li>
                                                                     ...
                                                                     font-family: Roboto;
                                                                     color: #323232;
                                                                     word-wrap: break-word;">{{date('d/m/Y',strtotime($data['date']))}}
                                                                                        </li>
                                                                     ...
                                                                     font-family: Roboto;
                                                                     color: #323232;
                                                                     word-wrap: break-word;">Q {{$data['document_price']}}
                                                                                        </li>
