                    ...
                    <div class="col-lg-8">
                        <div class="subscribe-form-wrap">
                            ...
                            <div class="form-section-start">
                                ...
                                <div class="form-desc">
                                    <form id="no_subscription_fill_buy_form" method="post">
                                        ...
                                        @foreach($labels as $key=>$variable)
                                            @if($variable->label_type !='date')    
                                                <div class="form-group confirm-val">
                                                    ...
                                                    <input type="text" data-label-type="{{$variable->label_type}}" name="field_{{$key}}" id="field_{{$key}}" class="form-control field_class fill-field" placeholder="Escribir..."  autocomplete="off">                                                                                                   
                                            ...
                                            @if($variable->label_type =='date')    
                                                @if($variable->label_name =='Fecha de nacimiento')
                                                    <div class="d-flx cal-wid-25">
                                                        <div class="form-group notranslate confirm-val">                                                
                                                            <label class="Ttulo">{{$variable->label_name}}</label>
                                                            <div class="input-group date" id="datetimepicker_{{$key}}" data-target-input="nearest">
                                                                <input type="text" data-label-type="{{$variable->label_type}}" name="field_{{$key}}" id="field_{{$key}}" class="form-control datetimepicker-input dob field_class fill-field" data-target="#datetimepicker_{{$key}}" placeholder="Indicar fecha…"  autocomplete="off"/>
                                                ...
                                                <div class="d-flx cal-wid-25">                               
                                                    <div class="form-group notranslate confirm-val">  
                                                        <label class="Ttulo">{{$variable->label_name}}</label>                                         
                                                        <div class="input-group date" id="datetimepicker_{{$key}}" data-target-input="nearest">
                                                            <input type="text" name="field_{{$key}}" data-label-type="{{$variable->label_type}}" id="field_{{$key}}" class="form-control datetimepicker-input not_dob field_class fill-field" data-target="#datetimepicker_{{$key}}" placeholder="Indicar fecha…"  autocomplete="off"/>
                                                            <div class="input-group-append" data-target="#datetimepicker_{{$key}}" data-toggle="datetimepicker">
                                                                <div class="input-group-text">
                                                                    <i class="icon-icons-calendar"></i>
                                                                </div>
                                        ...
                                        <div class="form-reg-bt">
                                            ...
                                            <input type="submit" class="btn btn-comon btn-blue disabled" value="Vista Previa">
                                                <!-- remove disabled once form filled -->
                                        </div>
                                    </form>
                                </div>
...
@push('js')
<script>
    var save_fill_buy = "{{route('user.nosubscription.fill.buy.store')}}";
</script>
