                    ...
                    <div class="col-lg-8">
                        <div class="subscribe-form-wrap">
                            ...
                            <div class="form-section-start">
                                ...
                                <div class="form-desc">
                                    {!! Form::model($nosubscription,['route' => ['user.nosubscription.fill.buy.update',$id], 'method' => 'POST','class' => 'kt-form','id'=>'edit_no_subscription_fill_buy_form',
                                            ...
                                            @if($variable->label_type !='date')  
                                                @if($variable->label_type == 'decimal')
                                                    ...
                                                    <div class="form-group confirm-val">
                                                        ...
                                                        <input type="text" data-label-type="{{$variable->label_type}}" name="field_{{$key}}" id="field_{{$key}}" class="form-control field_class edit-fill-field" placeholder="Escribir..."  value="{{ $decimal_field }}" autocomplete="off"> 
                                                    </div>
                                                @else                                         
                                                    <div class="form-group confirm-val">
                                                        <label class="Ttulo">{{$variable->label_name}}</label>
                                                        <input type="hidden" name="field_label" value="{{$variable->label_name}}">
                                                        <input type="text" data-label-type="{{$variable->label_type}}" name="field_{{$key}}" id="field_{{$key}}" class="form-control field_class edit-fill-field" placeholder="Escribir..."  value="{{  $field}}" autocomplete="off"> 
                                                            ...
                                                            <div class="d-flx cal-wid-25">
                                                                <div class="form-group confirm-val notranslate">  
                                                                    ...
                                                                    <div class="input-group date" id="datetimepicker_{{$key}}" data-target-input="nearest">
                                                                        <input type="text" data-label-type="{{$variable->label_type}}" name="field_{{$key}}" id="field_{{$key}}" class="form-control datetimepicker-input dob field_class edit-fill-field" data-target="#datetimepicker_{{$key}}" placeholder="Indicar fecha…"  value="{{date('d-m-Y',strtotime($field))}}" autocomplete="off"/>
                                                        ...
                                                        @else
                                                            <div class="d-flx cal-wid-25">                               
                                                                <div class="form-group confirm-val notranslate">  
                                                                    <label class="Ttulo">{{$variable->label_name}}</label>                                         
                                                                    <div class="input-group date" id="datetimepicker_{{$key}}" data-target-input="nearest">
                                                                        <input type="text"  data-label-type="{{$variable->label_type}}" name="field_{{$key}}" id="field_{{$key}}" class="form-control datetimepicker-input not_dob field_class edit-fill-field" data-target="#datetimepicker_{{$key}}" placeholder="Indicar fecha…"  value="{{date('d-m-Y',strtotime($field))}}" autocomplete="off"/>
                                                                        <div class="input-group-append" data-target="#datetimepicker_{{$key}}" data-toggle="datetimepicker">
                                                                            <div class="input-group-text">
                                                                                <i class="icon-icons-calendar"></i>
                                                                            </div>
                                            ...
                                            <div class="trans_data_wrap opacity_4">
                                                ...
                                                <div class="d-flx cal-wid-25">
                                                    <div class="form-group notranslate">  
                                                        <div class="input-group date" id="datetimepicker_{{$key}}" data-target-input="nearest">
                                                            <input type="text" data-label-type="{{$variable->label_type}}" class="form-control datetimepicker-input" data-target="#datetimepicker_{{$key}}" placeholder="Indicar fecha…"  disabled/>
                                                            <div class="input-group-append" data-target="#datetimepicker_{{$key}}" data-toggle="datetimepicker">
                                                                <div class="input-group-text">
                                                                    <i class="icon-icons-calendar"></i>
                                                                </div>
                                        ...
                                        <div class="fetch-info">
                                            <div class="trans_data_wrap">
                                                ...
                                                <div class="d-flx cal-wid-25">
                                                    <div class="form-group notranslate">                                              
                                                        <div class="input-group date" id="datetimepicker_{{$key}}" data-target-input="nearest">
                                                            <input type="text" name="expiry_date" class="form-control datetimepicker-input" data-target="#datetimepicker_{{$key}}" placeholder="Indicar fecha…"/>
                                                            <div class="input-group-append" data-target="#datetimepicker_{{$key}}" data-toggle="datetimepicker">
                                                                <div class="input-group-text">
                                                                    <i class="icon-icons-calendar"></i>
                                                                </div>
...
<script>
    ...
    var update_fill_buy = "{{route('user.nosubscription.fill.buy.update')}}";
